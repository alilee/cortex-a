...
pub use self::icc_bpr1_el1::ICC_BPR1_EL1;
pub use self::icc_ctlr_el1::ICC_CTLR_EL1;
pub use self::icc_igrpen1_el1::ICC_IGRPEN1_EL1;
pub use self::icc_pmr_el1::ICC_PMR_EL1;
pub use self::icc_sre_el1::ICC_SRE_EL1;
